 ...
 */
final class Version20250527132117 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE forum (id INT AUTO_INCREMENT NOT NULL, photos JSON NOT NULL COMMENT '(DC2Type:json)', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            INSERT INTO `user` (email, roles, password, firstname, lastname) VALUES ('admin@rasere.com', '["ROLE_USER"]', '$2y$13$hAZ8ak4dnkn./cxLF0bPPuKHweIfNNHHmuyyzFvqvH2dA5H89OKWi', 'Admin', 'Rasere')
        SQL);
        $this->addSql(<<<'SQL'
